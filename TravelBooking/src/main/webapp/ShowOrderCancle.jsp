<%-- 
    Document   : ShowOrderCancle
    Created on : May 23, 2024, 4:41:22 PM
    Author     : nguye
--%>
...
<html>
    ...
    <body>
        ...
        <div class="col-10 bg-light dashboard border" id="list">
            ...
            <div class="mb-3 p-3 ">
                <h3 class="mb-3">
                    <a href="OrderList.jsp">ORDER LIST</a>/ORDER CANCLE            
                </h3>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><button class="btn-cancle border">Cancle</button></td>
                            <td class="row-refund"></td>
